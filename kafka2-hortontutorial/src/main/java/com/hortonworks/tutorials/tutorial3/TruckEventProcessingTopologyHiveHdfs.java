 ...
 */
public class TruckEventProcessingTopologyHiveHdfs extends BaseTruckEventTopology 
{
    ...
    public TruckEventProcessingTopologyHiveHdfs(String configFileLocation) throws Exception 
    {
    ...
    public static void main(String[] str) throws Exception
    {
        ...
        TruckEventProcessingTopologyHiveHdfs truckTopology 
                = new TruckEventProcessingTopologyHiveHdfs(configFileLocation);
