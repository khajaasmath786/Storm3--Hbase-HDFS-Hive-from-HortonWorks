...
public class TruckHBaseBolt implements IRichBolt 
{
    ...
    {
    	LOG.info("Amath --> Inside prepare of hbase bolt..");
    ...
    {
    	LOG.info("Amath --> Inside execute of hbase bolt..");
    ...
    {
    	LOG.info("Amath --> Inside construct configuration of hbase bolt..");
    ...
    {
    	LOG.info("Amath --> Inside construct key of hbase bolt..");
