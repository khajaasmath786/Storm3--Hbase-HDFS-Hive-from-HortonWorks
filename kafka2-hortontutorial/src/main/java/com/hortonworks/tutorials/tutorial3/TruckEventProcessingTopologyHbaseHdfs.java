 ...
 */
public class TruckEventProcessingTopologyHbaseHdfs extends BaseTruckEventTopology 
{
    ...
    private static final Logger LOG = Logger.getLogger(TruckEventProcessingTopologyHbaseHdfs.class);
            
    public TruckEventProcessingTopologyHbaseHdfs(String configFileLocation) throws Exception 
    {
    ...
    {
    	LOG.info("Asmath ---> You are inside constructKafkaSpoutConf...");
    ...
    {
    	LOG.info("Asmath ---> You are inside configureKafkaSpout...");
...
/*        String sourceMetastoreUrl = topologyConfig.getProperty("hive.metastore.url");
    ...
    {
    	LOG.info("Asmath ---> You are inside configureHBaseBolt...");
        ...
        LOG.info("Asmath ---> You are outside of configureHBaseBolt...");
    }
    ...
    public static void main(String[] str) throws Exception
    {
        ...
        TruckEventProcessingTopologyHbaseHdfs truckTopology 
                = new TruckEventProcessingTopologyHbaseHdfs(configFileLocation);
